// Handle base64 encoded service account key for Vercel deployment
if (process.env.GOOGLE_SERVICE_ACCOUNT_KEY) {
    const fs = require('fs');
    const keyData = Buffer.from(process.env.GOOGLE_SERVICE_ACCOUNT_KEY, 'base64').toString();
    fs.writeFileSync('./service-account-key.json', keyData);
}
